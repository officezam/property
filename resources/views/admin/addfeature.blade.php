                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form action="{{ url('admin/feature') }}" method="post"  class="form-horizontal">
                                {!! csrf_field() !!}
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 @if($errors->first('name')) has-error @endif">
                                            ...
                                            <input type="text" name="name" value="" placeholder="Enter Feature Name" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
