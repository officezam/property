                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{ url('admin/updatecity' , $edit->id) }}" method="post"  class="form-horizontal">
                                {!! csrf_field() !!}
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="@if($errors->first('city')) has-error @endif">
                                            ...
                                            <input type="text" name="city" value="{{ $edit->name }}" placeholder="Enter City Name" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="@if($errors->first('zipcode')) has-error @endif">
                                            ...
                                            <input type="text" name="zipcode" value="{{ $edit->zipcode }}" placeholder="Enter City Zipcode" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
