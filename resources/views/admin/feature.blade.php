    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ url('admin/feature') }}">Features</a>
                </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <a href="/admin/feature/create" class=" btn btn-primary btn-lg pull-right">Add Feature</a>
                            </div>
                        </div>
                        <div class="panel-body">
...
<?php $var = 1; ?>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user['type'] }}</td>
                                    <td>
                                        <a href="/admin/feature/{{ $user['id'] }}/edit" class="btn default btn-xs purple">
                                            <i class="fa fa-edit"></i>
                                            Edit
                                        </a>
                                    </td>
                                    <td>
                                        <a href="/admin/featuredestroy/{{$user['id']}}" class="btn default btn-xs black">
