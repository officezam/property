...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">ContactUs view</li>
        </ol>
    </section>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <a href="{{ URL::action('ContactUsController@contactus_reply', ['id' => $data]) }}" title="Reply"><button class="label label-primary"> <i class="fa fa-reply">Reply</i></button></a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ URL::action('ContactUsController@destroy', ['id' => $data]) }}" type="button" class="btn btn-danger" >Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
