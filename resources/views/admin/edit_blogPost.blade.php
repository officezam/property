            ...
            <div class='col-lg-12'>
                ...
                <div class='box well well-sm'>
                    ...
                    <div class='box-body pad'>
                        <form method="POST" action="{{ URL::action('BlogController@update',['id' => $record]) }}"enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <textarea class="textarea editor-cls" placeholder="Place some text here" value="" style="height:500px" id="description" name="blog_post">{{ $record->blog_post}}</textarea>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="form-group" style="margin-top: 30px">
                                    <div class="col-md-6 ">
                                        <button type="submit" class="btn btn-success">
                                            <i class="glyphicon glyphicon-file"></i> Update Post
                                        </button>
                                    </div>
                                </div>
                            </div>
