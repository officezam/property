                   ...
                   <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <!--main content-->
                                <form action="RegisterAgent" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" value="{{old('name')}}" id="name"  placeholder="Enter your Agent Name">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="number"  name="number" value="{{old('number')}}" placeholder="Enter your Agent Number">
