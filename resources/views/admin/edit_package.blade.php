    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{url('admin/add_package')}}">Packages</a>
                </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form action="/admin/updatepkg/{{ $edit->id }}" method="post"  class="form-horizontal">
                                {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 @if($errors->first('packagename')) has-error @endif">
                                        ...
                                        <input type="text" name="packagename" value="{{ $edit->name }}" placeholder="Enter Package Name" class="form-control">
                                    </div>
                                </div>
                                <!-- Message body -->
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-8 @if($errors->first('description')) has-error @endif">
                                        ...
                                        <textarea class="form-control" id="description" name="description" placeholder="Please enter your description here..." rows="5">{{ $edit->description }}</textarea>
                                    </div>
                                </div>
