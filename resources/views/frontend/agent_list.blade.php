                            ...
                            <div class="profile-detail-block">
                                <div class="media">
                                    <div class="media-left">
                                        <figure>
                                            <img src="http://placehold.it/239x239" alt="Author Thumb" width="239" height="239">
                                        </figure>
                                        <a href="#" class="btn btn-primary btn-block hidden-xs">View My Properties</a>
                                    </div>
                                    <div class="media-body">
                                        <div class="profile-description">
                                            <h3>Michelle Ramirez</h3>
                                            <h4 class="position">Company Agent at Realtory Inc.</h4>
                                            ...
                                            <a href="#" class="btn btn-primary btn-block visible-xs">View My Properties</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="media-body">
                                        <div class="profile-description">
                                            ...
                                            <ul class="profile-contact">
                                                ...
                                                <li><span>MOBILE:</span> <a href="#">(765) 234 5678</a></li>
                                                <li><span>FAX:</span> <a href="#">(765) 234 5678</a></li>
                                                <li class="email"><span>Email:</span> <a href="mailto:brittany@houzez.com">brittany@houzez.com</a></li>
                                            </ul>
                                            <ul class="profile-social">
                                                <li><a href="#"><i class="fa fa-phone-square"></i></a></li>
                                                <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                                    ...
                                    <div class="media-body">
                                        <div class="profile-description">
                                            ...
                                            <ul class="profile-contact">
                                                ...
                                                <li><span>MOBILE:</span> <a href="#">(765) 234 5678</a></li>
                                                <li><span>FAX:</span> <a href="#">(765) 234 5678</a></li>
                                                <li class="email"><span>Email:</span> <a href="mailto:vincent@houzez.com">vincent@houzez.com</a></li>
                                            </ul>
                                            <ul class="profile-social">
                                                <li><a href="#"><i class="fa fa-phone-square"></i></a></li>
                                                <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
                                    ...
                                    <div class="media-body">
                                        <div class="profile-description">
                                            ...
                                            <ul class="profile-contact">
                                                ...
                                                <li><span>MOBILE:</span> <a href="#">(765) 234 5678</a></li>
                                                <li><span>FAX:</span> <a href="#">(765) 234 5678</a></li>
                                                <li class="email"><span>Email:</span> <a href="mailto:samuel@houzez.com">samuel@houzez.com</a></li>
                                            </ul>
                                            <ul class="profile-social">
                                                <li><a href="#"><i class="fa fa-phone-square"></i></a></li>
                                                <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
